...
public class SDLActivity extends AppCompatActivity {
    private static final String TAG = "Termux SDLActivity";
    
    //private static final String TERMUX_URL="https://play.google.com/store/apps/details?id=com.termux";
