...
include $(PROJ_PATH)/SDL2_image/external/libwebp-0.3.0/Android.mk
include $(PROJ_PATH)/SDL2_image/Android.mk
include $(PROJ_PATH)/SDL2_mixer/external/libmikmod-3.1.12/Android.mk
include $(PROJ_PATH)/SDL2_mixer/external/smpeg2-2.0.0/Android.mk
